...
\begin{figure}[ht]
        \centering
        \includegraphics[width=0.8\textwidth]{zhexian-lk-upgrade.png}
        \caption{小k场景优化前后对比图}
...
可以发现随着输入数据规模的增大，相较于原来版本的加速效果越来越好。
    \begin{figure}[ht]
        \centering
        \includegraphics[width=0.9\textwidth]{zhexian-lk-vsorigin.png}
        \caption{小k场景优化前后对比图}
...
\end{table}
    ...
    \begin{figure}[ht]
        \centering
        \includegraphics[width=0.8\textwidth]{zhexian-lkvsA100.png}
        % \caption{小k场景优化前后对比图}
    ...
    \begin{figure}[ht]
        \centering
        \includegraphics[width=0.8\textwidth]{zhexian-lkvsA100-2.png}
        \caption{小k场景优化前后对比图}
...
\begin{table}
    ...
    \begin{figure}[ht]
        \centering
        \includegraphics[width=0.8\textwidth]{zhexian-bk-upgrade.png}
        \caption{大k场景优化前后对比图}
...
\begin{table}
    ...
    \begin{figure}[ht]
        \centering
        \includegraphics[width=0.7\textwidth]{zhexian-bk-vsorigin.png}
        \caption{与原版本性能对比图}
