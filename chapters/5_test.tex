...
\begin{table}
    ...
    % （1,131072） & 1024 &  1     & True        & 45 & 79 & 0.43 \\
    % （1,131072） & 2048 &  1     & True        & 51 & 80 & 0.36 \\
    % （1,131072） & 4096 &  1     & True        & 67 & 82 & 0.18 \\
    % （1,131072） & 8192 &  1     & True       & 102 & 145 & 0.30 \\
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{zhexian-lkvsA100-3.png}
...
%     \label{fig:bench_littlek_vsa100_zhexian_0}
% \end{figure}
...
\begin{table}
    ...
    % （1,131072） & 16384   &  1     & True & 76.2 & 153 & 0.5020\\
    % （1,131072） & 32768   & 1     & True &  85.5 & 155 & 0.4484\\
    % （1,131072） & 65536   & 1     & True &  102.1 & 157 & 0.3497  \\
    ...
    \begin{figure}[ht]
        \centering
        \includegraphics[width=0.75\textwidth]{zhexian-bkvsA100-1.png}
        \caption{大k场景下DLP-M/A100性能对比图}
